...
<div class="pagination">
    <ul>
        <li><a href="money.jsp?pageNo=<c:out value="${pageNo}"/>">Prev</a></li>
        <li><a href="money.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo}"/></a></li>
        <li><a href="money.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo+1}"/></a></li>
        <li><a href="money.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo+2}"/></a></li>
        <li><a href="money.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo+3}"/></a></li>
        <li><a href="money.jsp?pageNo=<c:out value="${pageNo}"/>">Next</a></li>
    </ul>
</div>
