...
<div class="well">
        ...
        <table class="table">
          ...
          <tbody>
			<c:forEach items="${sellInfos}" var="i" begin="<c:out value="${pageNo*3}"/>" end="<c:out value="${pageNo*3 + 3}"/>">
				<tr>
					<td><c:out value="${i.id}" /></td>
					<td><c:out value="${i.sellBookName}" /></td>
					<td><c:out value="${i.userName}" /></td>
					<td><c:out value="${i.sellNum}" /></td>
					<td><c:out value="${i.money}" /></td>
					<td><c:out value="${i.method}" /></td>
					<td><c:out value="${i.takeBookNum}" /></td>
					<td><c:out value="${i.sellTime}" /></td>
  ...
  <div class="pagination">
      <ul>
          <li><a href="sell.jsp?pageNo=<c:out value="${pageNo}"/>">Prev</a></li>
          <li><span><c:out value="${pageNo}"/></span>
          <li><a href="sell.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo + 1}"/></a></li>
          <li><a href="sell.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo + 1}"/></a></li>
          <li><a href="sell.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo + 1}"/></a></li>
          <li><a href="sell.jsp?pageNo=<c:out value="${pageNo}"/>">Next</a></li>
      </ul>
  </div>
