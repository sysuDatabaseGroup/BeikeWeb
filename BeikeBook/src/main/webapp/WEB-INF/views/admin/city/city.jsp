...
<div class="btn-toolbar">
    <a href="cityadd.jsp" style="color:#fff;"><button class="btn btn-primary"><i class="icon-plus"></i> 增加城市</button></a>
</div>
...
<div class="well">
    <table class="table">
      ...
      <tbody>
		<c:forEach items="${cityInfos}" var="i" begin="<c:out value="${pageNo*5}"/>" end="<c:out value="${pageNo*5 + 5}"/>">
			<tr>
				<td><c:out value="${i.cityNum}" /></td>
				<td><c:out value="${i.cityName}" /></td>
				<td><c:out value="${i.cityAbbreviate}" /></td>
				<td>
				    <a href="cityedit.jsp"><i class="icon-pencil"></i><span>编辑</span></a>
...
<div class="pagination">
    <ul>
        <li><a href="city.jsp?pageNo=<c:out value="${pageNo}"/>">Prev</a></li>
        <li><a href="city.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo}"/></a></li>
        <li><a href="city.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo+1}"/></a></li>
        <li><a href="city.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo+2}"/></a></li>
        <li><a href="city.jsp?pageNo=<c:out value="${pageNo}"/>"><c:out value="${pageNo+3}"/></a></li>
        <li><a href="city.jsp?pageNo=<c:out value="${pageNo}"/>">Next</a></li>
    </ul>
</div>
